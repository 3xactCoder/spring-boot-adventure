...
class CategoryControllerTest {
    ...
    @DisplayName("Create category with ADMIN role - 201 Created")
    ...
    @Sql(scripts = "classpath:database/clear-books-and-categories.sql",
            executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @DisplayName("Get category by ID with USER role - 200 OK")
    ...
    @Sql(scripts = "classpath:database/clear-books-and-categories.sql",
            executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @DisplayName("Delete category with ADMIN role - 204 No Content")
